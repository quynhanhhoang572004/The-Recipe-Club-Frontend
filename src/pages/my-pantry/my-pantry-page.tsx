...
const MyPantryPage = () => {
  const tags = ["Key ingredients", "Key exclude", "Quick&Easy", "Cusinses", 
    " Diet", "Missing One ingredient", "Video only",
     "Max Ingredient", "Rating", "Recipe Time"]
  ...
  flexDirection: "row",    
    ...
    <Box sx={{ width: "25rem", flexShrink: 0, height:"100%" }}>
        <SideBar>
          <Box
            sx={{
              textAlign: "center",
